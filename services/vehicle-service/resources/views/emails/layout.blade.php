...
<head>
    ...
    <title>@yield('title', 'UniWheels — Gestión Administrativa')</title>
    <style>
...
<div class="email-wrapper">
    <div class="email-container">
        <div class="email-header">
            ...
            <p class="email-header-subtitle">@yield('header_subtitle', 'Panel de Auditoría y Verificación Vehicular')</p>
        </div>
        ...
        <div class="email-footer">
            © {{ date('Y') }} <strong>UniWheels Admin</strong> — Red Oficial de Movilidad Universitaria Segura.<br>
