...
import { Car, X, ArrowRight, ShieldCheck, CheckCircle2 } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs select-none">
        <motion.div
          ...
          className="w-full max-w-[340px] bg-white rounded-3xl p-5 shadow-2xl border border-slate-100 overflow-hidden text-slate-900 mx-auto space-y-4"
        >
          {/* Cabecera */}
          <div className="flex items-center justify-between pb-2 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-900">Activar Modo Conductor</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="space-y-2 bg-lochmara-50/70 p-3 rounded-2xl border border-lochmara-100 text-[11px] text-slate-700">
            <div className="flex items-center gap-2">
